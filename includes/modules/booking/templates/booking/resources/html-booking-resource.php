...
<div class="woocommerce_booking_resource wc-metabox closed">
	<h3>
		<button type="button" class="dokan-btn dokan-btn-theme remove_booking_resource button" rel="<?php echo esc_attr( absint( $resource_id ) ); ?>"><?php _e( 'Remove', 'dokan-wc-booking' ); ?></button>

		<!--<a href="<?php //echo admin_url( 'post.php?post=' . $resource_id . '&action=edit' ); ?>" target="_blank" class="edit_resource"><?php //_e( 'Edit resource', 'dokan-wc-booking' ); ?> &rarr;</a>-->
