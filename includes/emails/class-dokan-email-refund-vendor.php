...
class Dokan_Email_Refund_Vendor extends WC_Email {
	...
	public function __construct() {
		...
		$this->title            = __( 'Dokan Refund Processed', 'dokan-lite' );
		$this->description      = __( 'These emails are sent to vendor when a vendor refund request is processed', 'dokan-lite' );
	...
	public function get_default_subject() {
            return __( '[{site_name}] Your refund request was {status}', 'dokan-lite' );
	}
	...
	public function get_default_heading() {
            return __( 'Refund request for {order_id} is {status}', 'dokan-lite' );
	}
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'subject' => array(
				...
				'description'   => sprintf( __( 'Available placeholders: %s', 'dokan-lite' ), '<code>{site_name},{amount},{seller_name},{order_id},{status}</code>' ),
