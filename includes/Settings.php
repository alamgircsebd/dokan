...
class Settings extends DokanSettings {
    ...
    public function load_settings_header( $header, $query_vars ) {
        ...
        if ( $query_vars == 'shipping' ) {
            ...
            $header = sprintf( '%s <span style="position:absolute; right:0px;"><a href="%s" class="dokan-btn dokan-btn-default"><i class="fa fa-gear"></i> Click here to add Shipping Policies</a></span>', __( 'Shipping Settings', 'dokan' ), $settings_url ) ;
        }
