...
class Refund extends DokanModel {
    ...
    protected function set_data( $data ) {
        ...
        $this->set_id( $data['id'] )
            ...
            ->set_item_totals( wc_format_decimal( $data['item_totals'], wc_get_price_decimals() ) )
            ->set_item_tax_totals( wc_format_decimal( $data['item_tax_totals'], wc_get_price_decimals() ) )
