...
<div class="wrap">
    <h2><?php _e( 'Vendor Listing', 'dokan-pro' ); ?></h2>
        ...
        <table class="widefat withdraw-table">
            <thead>
                <tr>
                    ...
                    <th><?php _e( 'Username', 'dokan-pro' ); ?></th>
                    <th><?php _e( 'Name', 'dokan-pro' ); ?></th>
                    <th><?php _e( 'Shop Name', 'dokan-pro' ); ?></th>
                    <th><?php _e( 'E-mail', 'dokan-pro' ); ?></th>
                    <th><?php _e( 'Products', 'dokan-pro' ); ?></th>
                    <th><?php _e( 'Balance', 'dokan-pro' ); ?></th>
                    <th><?php _e( 'Phone Number', 'dokan-pro' ); ?></th>
                    <th><?php _e( 'Status', 'dokan-pro' ); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                if ( $sellers ) {
                    ...
                    foreach ($sellers as $user) {
                        ...
                        <tr class="<?php echo ($count % 2 == 0) ? 'alternate' : 'odd'; ?> ">
                            ...
                            <td>
                                ...
                                <div class="row-actions toggle-seller-status">
                                    <?php if ( !$seller_enable ) { ?>
                                        <span class="active"><a class="toggle-seller" href="#" data-id="<?php echo $user->ID; ?>" data-type="yes"><?php _e( 'Activate Selling', 'dokan-pro' ); ?></a> | </span>
                                    <?php } else { ?>
                                        <span class="active delete"><a class="toggle-seller" href="#" data-id="<?php echo $user->ID; ?>" data-type="no"><?php _e( 'Make Inactivate', 'dokan-pro' ); ?></a> | </span>
                                    <?php } ?>

                                    <span class="products-link"><a href="<?php echo admin_url( 'edit.php?post_type=product&author=' . $user->ID ); ?>"><?php _e( 'Products', 'dokan-pro' ); ?></a> | </span>
                                    <span class="orders-link"><a href="<?php echo admin_url( 'edit.php?post_type=shop_order&author=' . $user->ID ); ?>"><?php _e( 'Orders', 'dokan-pro' ); ?></a></span>
                                </div>
                            </td>
                            ...
                            <td>
                                <?php if ( $seller_enable ) {
                                    echo '<span class="seller-active">' . __( 'Active', 'dokan-pro' ) . '</span>';
                                } else {
                                    echo '<span class="seller-inactive">' . __( 'Inactive', 'dokan-pro' ) . '</span>';
                                } ?>
                            </td>
                        </tr>
                        <?php
                    ...
                    echo '<tr><td colspan="9">' . __( 'No users found!', 'dokan-pro' ) .'</td></tr>';
                }
                ?>
            </tbody>
            <tfoot>
        ...
        <div class="tablenav bottom">
            ...
            if ( $num_of_pages > 1 ) {
                $page_links = paginate_links( array(
                    ...
                    'prev_text' => __( '&larr; Previous', 'dokan-pro' ),
                    'next_text' => __( 'Next &rarr;', 'dokan-pro' ),
                    'add_args'  => false,
                ) );
