            ...
            <header class="dokan-dashboard-header dokan-clearfix">
                ...
                <?php if ( !$is_edit_page ) { ?>
                    <span class="left-header-content dokan-right">
                        <a href="<?php echo add_query_arg( array( 'view' => 'add_coupons'), dokan_get_navigation_url( 'coupons' ) ); ?>" class="dokan-btn dokan-btn-orange dokan-right"><i class="fa fa-gift">&nbsp;</i> <?php _e( 'Add new Coupon', 'dokan' ); ?></a>
                    </span>
                <?php } ?>
            </header><!-- .entry-header -->
