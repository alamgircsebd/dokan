...
<tr class="shipping <?php echo ( ! empty( $class ) ) ? $class : ''; ?>" data-order_item_id="<?php echo $item_id; ?>">
	...
	<td class="line_cost" width="1%">
		<div class="view">
			<?php
				echo ( isset( $item['cost'] ) ) ? wc_price( wc_round_tax_total( $item['cost'] ), array( 'currency' => dokan_cmp_get_prop( $order, 'get_order_currency', 'get_currency' ) ) ) : '';
			...
			foreach ( $order_taxes as $tax_item ) :
				...
				?>
					<td class="line_tax" width="1%">
						<div class="view">
							<?php
								echo ( '' != $tax_item_total ) ? wc_price( wc_round_tax_total( $tax_item_total ), array( 'currency' => dokan_cmp_get_prop( $order, 'get_order_currency', 'get_currency' ) ) ) : '&ndash;';
