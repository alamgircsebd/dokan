<script type="text/html" id="tmpl-sc-category">
    <div class="inputs-box woocommerce_attribute" data-count="[{{ data.row }}]">
        ...
        <div class="box-header">
            <input type="text" class="category-name" placeholder="<?php esc_attr_e( 'Category name', 'dokan-pro' ); ?>" name="attribute_names[{{ data.row }}]" value="">
        ...
        <div class="box-inside dokan-clearfix">
                ...
                <ul class="list-unstyled ">
                    <li>
                        <label class="checkbox-inline">
                            <input type="checkbox" class="checkbox" name="attribute_visibility[{{ data.row }}]" value="1" /> <?php _e( 'Visible on the product page', 'dokan-pro' ); ?>
                        </label>
                    </li>

                    <li class="enable_variation show_if_variable">
                        <label class="checkbox-inline">
                            <input type="checkbox" class="checkbox" name="attribute_variation[{{ data.row }}]" value="1" /> <?php _e( 'Used for variations', 'dokan-pro' ); ?>
                        </label>
                    </li>
                </ul>
            </div>
            ...
            <div class="attribute-options">
                <ul class="option-couplet list-unstyled ">
                    <li>
                        <input type="text" class="option" placeholder="<?php esc_attr_e( 'Option...', 'dokan-pro' ); ?>" name="attribute_values[{{ data.row }}][0]">
...
<script type="text/html" id="tmpl-sc-category-item">
    <li>
        <input type="text" class="option" placeholder="<?php esc_attr_e( 'Option...', 'dokan-pro' ); ?>" name="attribute_values[<%= row %>][<%= col %>]">
