...
<div class="dokan-product-shipping-tax hide_if_virtual dokan-edit-row dokan-clearfix dokan-border-top <?php echo ( 'no' == get_option('woocommerce_calc_shipping') ) ? 'woocommerce-no-shipping' : '' ?> <?php echo ( 'no' == get_option('woocommerce_calc_taxes') ) ? 'woocommerce-no-tax' : '' ?>">
    <div class="dokan-section-heading" data-togglehandler="dokan_product_shipping_tax">
        <h2><i class="fa fa-truck" aria-hidden="true"></i> <?php _e( 'Shipping and Tax', 'dokan-pro' ); ?></h2>
        <p><?php _e( 'Manage shipping and tax for this product', 'dokan-pro' ); ?></p>
            ...
            <div class="dokan-clearfix dokan-shipping-container">
                ...
                <div class="dokan-form-group">
                    <label class="dokan-checkbox-inline" for="_disable_shipping">
                        ...
                        <?php _e( 'This product requires shipping', 'dokan-pro' ); ?>
                    </label>
                </div>

                <div class="show_if_needs_shipping dokan-shipping-dimention-options">
                    <?php dokan_post_input_box( $post_id, '_weight', array( 'class' => 'dokan-form-control', 'placeholder' => __( 'weight (' . esc_html( get_option( 'woocommerce_weight_unit' ) ) . ')', 'dokan-pro' ) ), 'number' ); ?>
                    <?php dokan_post_input_box( $post_id, '_length', array( 'class' => 'dokan-form-control', 'placeholder' => __( 'length (' . esc_html( get_option( 'woocommerce_dimension_unit' ) ) . ')', 'dokan-pro' ) ), 'number' ); ?>
                    <?php dokan_post_input_box( $post_id, '_width', array( 'class' => 'dokan-form-control', 'placeholder' => __( 'width (' . esc_html( get_option( 'woocommerce_dimension_unit' ) ) . ')', 'dokan-pro' ) ), 'number' ); ?>
                    <?php dokan_post_input_box( $post_id, '_height', array( 'class' => 'dokan-form-control', 'placeholder' => __( 'height (' . esc_html( get_option( 'woocommerce_dimension_unit' ) ) . ')', 'dokan-pro' ) ), 'number' ); ?>
                    <div class="dokan-clearfix"></div>
                </div>
                ...
                <div class="show_if_needs_shipping dokan-form-group">
                    <label class="control-label" for="product_shipping_class"><?php _e( 'Shipping Class', 'dokan-pro' ); ?></label>
                    <div class="dokan-text-left">
                        ...
                        $args = array(
                            ...
                            'hide_empty'        => 0,
                            'show_option_none'  => __( 'No shipping class', 'dokan-pro' ),
                        ...
                        <p class="help-block"><?php _e( 'Shipping classes are used by certain shipping methods to group similar products.', 'dokan-pro' ); ?></p>
                    </div>
                </div>
                <?php if( $dokan_shipping_enabled == 'yes' && $store_shipping == 'yes' ) : ?>
                    <div class="show_if_needs_shipping dokan-shipping-product-options">
                        ...
                        <div class="dokan-form-group">
                            <?php dokan_post_input_box( $post_id, '_overwrite_shipping', array( 'label' => __( 'Override default shipping cost for this product', 'dokan-pro' ) ), 'checkbox' ); ?>
                        </div>

                        <div class="dokan-additional-shipping-wrap show_if_override">
                            <div class="dokan-form-group dokan-w3">
                                <label class="dokan-control-label" for="_additional_product_price"><?php _e( 'Additional cost', 'dokan-pro' ); ?></label>
                            ...
                            <div class="dokan-form-group dokan-w3">
                                <label class="dokan-control-label" for="dps_additional_qty"><?php _e( 'Per Qty Additional Price', 'dokan-pro' ); ?></label>
                            ...
                            <div class="dokan-form-group dokan-w3 last-child">
                                <label class="dokan-control-label" for="dps_additional_qty"><?php _e( 'Processing Time', 'dokan-pro' ); ?></label>
        ...
        <div class="dokan-clearfix dokan-tax-container show_if_variable show_if_simple">
            <div class="dokan-tax-product-options">
                <div class="dokan-form-group content-half-part">
                    <label class="dokan-control-label" for="_tax_status"><?php _e( 'Tax Status', 'dokan-pro' ); ?></label>
                    <div class="dokan-text-left">
                ...
                <div class="dokan-form-group content-half-part">
                    <label class="dokan-control-label" for="_tax_class"><?php _e( 'Tax Class', 'dokan-pro' ); ?></label>
                    <div class="dokan-text-left">
