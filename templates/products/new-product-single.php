                            ...
                            <div class="dokan-form-top-area">
                                ...
                                <div class="content-half-part dokan-product-meta">
                                    ...
                                    <div class="dokan-form-group">
                                        ...
                                        echo '<select multiple="multiple" name="product_tag[]" id="product_tag_search" class="product_tags dokan-form-control dokan-select2">';
                                            foreach ( $my_tax_terms as $tax_term ) {
                                                if ( !empty( $term ) && in_array( $tax_term->term_id, $term ) ) {
                                                    echo '<option value="'. $tax_term->term_id .'" selected="selected" >'. $tax_term->name .'</option>';
                                                }
                                            }
                                        echo '</select>';
