            ...
            if ( $order_id ) {
                ...
                <form action="" method="GET" class="dokan-left">
                    <div class="dokan-form-group">
                        ...
                        <input type="submit" name="dokan_order_filter" class="dokan-btn dokan-theme" value="Filter">
                ...
                <form action="" method="POST" class="dokan-right">
                    <div class="dokan-form-group">
                        <input type="submit" name="dokan_order_export_all"  class="dokan-btn dokan-theme" value="Export All">
                        <input type="submit" name="dokan_order_export_filtered"  class="dokan-btn dokan-theme" value="Export Filtered">
