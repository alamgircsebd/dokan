...
<div class="show_if_seller"<?php echo $role_style; ?>>
    ...
    ?>
            <p class="form-row form-group form-row-wide">
                ...
                <label style="display: inline" for="tc_agree"><?php _e( 'I have read and agree to the', 'dokan' ); ?> <a target="_blank" href="<?php echo $toc_page_url ?>"><?php _e( 'Terms &amp; Conditions', 'dokan' ); ?></a>.</label>
            </p>    
            <?php } ?>
        <?php } ?>
