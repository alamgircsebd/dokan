...
<h2><?php _e( 'Update account to Vendor', 'dokan-pro' ); ?></h2>
    ...
    <div class="dokan-become-seller">
        ...
        <div class="split-row form-row-wide">
            <p class="form-row form-group">
                <label for="first-name"><?php _e( 'First Name', 'dokan-pro' ); ?> <span class="required">*</span></label>
            ...
            <p class="form-row form-group">
                <label for="last-name"><?php _e( 'Last Name', 'dokan-pro' ); ?> <span class="required">*</span></label>
        ...
        <p class="form-row form-group form-row-wide">
            <label for="company-name"><?php _e( 'Shop Name', 'dokan-pro' ); ?> <span class="required">*</span></label>
        ...
        <p class="form-row form-group form-row-wide">
            <label for="seller-url" class="pull-left"><?php _e( 'Shop URL', 'dokan-pro' ); ?> <span class="required">*</span></label>
        ...
        <p class="form-row form-group form-row-wide">
            <label for="seller-address"><?php _e( 'Address', 'dokan-pro' ); ?><span class="required">*</span></label>
        ...
        <p class="form-row form-group form-row-wide">
            <label for="shop-phone"><?php _e( 'Phone Number', 'dokan-pro' ); ?><span class="required">*</span></label>
        ...
        if ( $show_toc == 'on' ) {
            ...
            if ( $toc_page_id != -1 ) {
                ...
                <p class="form-row form-group form-row-wide">
                    ...
                    <label style="display: inline" for="tc_agree"><?php echo sprintf( __( 'I have read and agree to the <a target="_blank" href="%s">Terms &amp; Conditions</a>.', 'dokan-pro' ), $toc_page_url ); ?></label>
                </p>
            <?php } ?>
        <?php } ?>
        ...
        <?php wp_nonce_field( 'account_migration', 'dokan_nonce' ); ?>
            ...
            <input type="submit" class="dokan-btn dokan-btn-default" name="dokan_migration" value="<?php _e( 'Become a Vendor', 'dokan-pro' ); ?>" />
        </p>
    </div>
</form>
